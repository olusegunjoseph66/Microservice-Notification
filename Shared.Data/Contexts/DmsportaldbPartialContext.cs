    ...
    public partial class DmsportaldbContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=tcp:dms-db-server.database.windows.net,1433;Initial Catalog=dms-dev-db;Persist Security Info=False;User ID=server-admin;Password=6oVflU2mp4pjZFMe10zUJMccmskzG3;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
